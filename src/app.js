...
app.get('/', (req, res) => {
  res.send(`<h1>Welcome to the Hostels Bookings Application</h1>
  <h4>Please use PostMan and navigate to <code>/api/v1</code> to use the app</h4>
  <p>For any more info please visit my <a href='https://github.com/fegoworks/hostel_bookings'>Github</a> page</P>
  <h4>Thanks  &#x1F600;</h4>`);
});
